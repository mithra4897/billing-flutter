...
class SalesReturnLineModel extends JsonModel {
  ...
  factory SalesReturnLineModel.fromJson(Map<String, dynamic> json) {
    return SalesReturnLineModel(
      ...
      salesReturnId: JsonModel.nullableInt(json['sales_return_id']),
      salesInvoiceLineId: JsonModel.nullableInt(json['sales_invoice_line_id']),
