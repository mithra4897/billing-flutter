...
class SalesProformaInvoiceLineModel extends JsonModel {
  const SalesProformaInvoiceLineModel({
    super.id,
  ...
  factory SalesProformaInvoiceLineModel.fromJson(Map<String, dynamic> json) {
    return SalesProformaInvoiceLineModel(
      id: JsonModel.nullableInt(json['id']),
      salesProformaInvoiceId: JsonModel.nullableInt(
        json['sales_proforma_invoice_id'],
      ),
  ...
  String toString() => JsonModel.combineValues([
    lineNo,
  ], defaultValue: 'Sales Proforma Invoice Line');
