...
class BomModel extends JsonModel {
  ...
  factory BomModel.fromJson(Map<String, dynamic> json) {
    return BomModel(
      ...
      batchSize: JsonModel.nullableDouble(json['batch_size']),
      standardOutputQty: JsonModel.nullableDouble(json['standard_output_qty']),
      scrapPercent: JsonModel.nullableDouble(json['scrap_percent']),
      yieldPercent: JsonModel.nullableDouble(json['yield_percent']),
