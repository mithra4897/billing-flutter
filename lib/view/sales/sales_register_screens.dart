...
typedef _SalesRegisterFooterCell = PurchaseRegisterSummaryFooterCell;
typedef _SalesRegisterSummaryFooter = PurchaseRegisterSummaryFooter;
    ...
    return _SalesRegisterShell<SalesInvoiceModel>(
      ...
      matches: (row, query, statuses, customFilters) {
        ...
        final searchText = [
          row.invoiceNo ?? '',
          rowStatus,
          salesInvoiceStatusLabel(rowStatus),
          _salesCustomerName(data),
        ].join(' ').toLowerCase();
      ...
      columns: [
        ...
        PurchaseRegisterColumn(
          label: 'Status',
          valueBuilder: (row) => salesInvoiceStatusLabel(row.invoiceStatus),
          widgetBuilder: (context, row) => salesStatusBadge(
            context,
            row.invoiceStatus,
            dueDate: row.dueDate,
