  ...
  Widget _buildConstrainedContent(
    ...
    return ProjectSubtabExpandableSection(
      ...
      recordTiles: controller.filteredRows.map((row) {
        final expanded = controller.selectedRow?.timesheet.id == row.timesheet.id;
        return Padding(
          padding: const EdgeInsets.only(bottom: AppUiConstants.spacingSm),
          child: SettingsExpandableTile(
            key: ValueKey<String>('project-timesheet-${row.timesheet.id}-$expanded'),
            title: controller.employeeName(row.timesheet.employeeId).isNotEmpty
                ? controller.employeeName(row.timesheet.employeeId)
                : 'Timesheet',
            subtitle: [
          ...
          SettingsFormWrap(
            children: [
              ...
              AppFormTextField(
                ...
                validator: Validators.optionalNonNegativeNumber('Billable Rate'),
              ),
              AppFormTextField(
