...
class QcInspectionModel implements JsonModel {
  ...
  factory QcInspectionModel.fromJson(Map<String, dynamic> json) {
    return QcInspectionModel(
      ...
      qcPlanId: ModelValue.nullableInt(json['qc_plan_id']),
      ...
      sampleSize: ModelValue.nullableDouble(json['sample_size']),
      inspectedQty: ModelValue.nullableDouble(json['inspected_qty']),
      acceptedQty: ModelValue.nullableDouble(json['accepted_qty']),
      rejectedQty: ModelValue.nullableDouble(json['rejected_qty']),
      holdQty: ModelValue.nullableDouble(json['hold_qty']),
      reworkQty: ModelValue.nullableDouble(json['rework_qty']),
      inspectionStatus: json['inspection_status']?.toString(),
      finalResult: json['final_result']?.toString(),
      inspectedBy: ModelValue.nullableInt(json['inspected_by']),
