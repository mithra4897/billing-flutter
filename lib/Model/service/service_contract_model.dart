...
class ServiceContractModel extends JsonModel {
  ...
  factory ServiceContractModel.fromJson(Map<String, dynamic> json) {
    return ServiceContractModel(
      ...
      responseTimeHours: ModelValue.nullableDouble(json['response_time_hours']),
      resolutionTimeHours: ModelValue.nullableDouble(
        json['resolution_time_hours'],
      ),
      contractValue: ModelValue.nullableDouble(json['contract_value']),
      taxAmount: ModelValue.nullableDouble(json['tax_amount']),
      totalValue: ModelValue.nullableDouble(json['total_value']),
  ...
  @override
  String toString() => 'Service Contract';
