...
class MrpSupplyModel implements JsonModel {
  ...
  factory MrpSupplyModel.fromJson(Map<String, dynamic> json) {
    return MrpSupplyModel(
      ...
      supplyQty: ModelValue.nullableDouble(json['supply_qty']),
      allocatedQty: ModelValue.nullableDouble(json['allocated_qty']),
      availableQty: ModelValue.nullableDouble(json['available_qty']),
