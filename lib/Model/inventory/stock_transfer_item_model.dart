...
class StockTransferItemModel implements JsonModel {
  ...
  factory StockTransferItemModel.fromJson(Map<String, dynamic> json) {
    return StockTransferItemModel(
      ...
      stockTransferId: ModelValue.nullableInt(json['stock_transfer_id']),
      lineNo: ModelValue.nullableInt(json['line_no']),
      itemId: ModelValue.nullableInt(json['item_id']),
      fromBatchId: ModelValue.nullableInt(json['from_batch_id']),
      toBatchId: ModelValue.nullableInt(json['to_batch_id']),
      fromSerialId: ModelValue.nullableInt(json['from_serial_id']),
      toSerialId: ModelValue.nullableInt(json['to_serial_id']),
      uomId: ModelValue.nullableInt(json['uom_id']),
      transferQty: ModelValue.nullableDouble(json['transfer_qty']),
