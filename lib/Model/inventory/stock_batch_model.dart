...
class StockBatchModel extends JsonModel {
  ...
  factory StockBatchModel.fromJson(Map<String, dynamic> json) {
    return StockBatchModel(
      ...
      inwardQty: JsonModel.nullableDouble(json['inward_qty']),
      outwardQty: JsonModel.nullableDouble(json['outward_qty']),
      balanceQty: JsonModel.nullableDouble(json['balance_qty']),
      qtyAvailable: JsonModel.nullableDouble(json['qty_available']),
      purchaseRate: JsonModel.nullableDouble(json['purchase_rate']),
      salesRate: JsonModel.nullableDouble(json['sales_rate']),
      mrp: JsonModel.nullableDouble(json['mrp']),
