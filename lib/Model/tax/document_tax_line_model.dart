...
class DocumentTaxLineModel extends JsonModel {
  ...
  factory DocumentTaxLineModel.fromJson(Map<String, dynamic> json) {
    return DocumentTaxLineModel(
      ...
      lineId: JsonModel.nullableInt(json['line_id']),
      ...
      cgstPercent: JsonModel.nullableDouble(json['cgst_percent']),
      cgstAmount: JsonModel.nullableDouble(json['cgst_amount']),
      sgstPercent: JsonModel.nullableDouble(json['sgst_percent']),
      sgstAmount: JsonModel.nullableDouble(json['sgst_amount']),
      igstPercent: JsonModel.nullableDouble(json['igst_percent']),
      igstAmount: JsonModel.nullableDouble(json['igst_amount']),
      cessPercent: JsonModel.nullableDouble(json['cess_percent']),
      ...
      reverseChargeApplicable: json['reverse_charge_applicable'] == null
          ? null
          : JsonModel.boolOf(json['reverse_charge_applicable']),
      inputTaxCreditAllowed: json['input_tax_credit_allowed'] == null
          ? null
          : JsonModel.boolOf(json['input_tax_credit_allowed']),
