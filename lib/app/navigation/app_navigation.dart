        ...
        AppNavigationItem(
          ...
          children: [
            AppNavigationItem(
              ...
              path: '/accounting/reports?report_type=day_book',
              requiredPermissions: ['accounts.view'],
            ),
            AppNavigationItem(
              key: 'general-ledger',
              ...
              icon: Icons.account_tree_outlined,
              path: '/accounting/reports?report_type=general_ledger',
              requiredPermissions: ['accounts.view'],
            ),
            AppNavigationItem(
              key: 'accounts-receivable-aging',
              title: 'Accounts Receivable Aging',
              icon: Icons.people_outline,
              path: '/accounting/reports?report_type=accounts_receivable_aging',
              requiredPermissions: ['accounts.view'],
            ),
            AppNavigationItem(
              ...
              icon: Icons.receipt_long_outlined,
              path: '/accounting/reports?report_type=accounts_payable_aging',
              requiredPermissions: ['accounts.view'],
            ),
            AppNavigationItem(
              key: 'trial-balance',
              ...
              path: '/accounting/reports?report_type=trial_balance',
              requiredPermissions: ['accounts.view'],
            ),
            AppNavigationItem(
              key: 'profit-and-loss',
              ...
              path: '/accounting/reports?report_type=profit_and_loss',
              requiredPermissions: ['accounts.view'],
            ),
            AppNavigationItem(
              key: 'balance-sheet',
              title: 'Balance Sheet',
              icon: Icons.account_balance_outlined,
              path: '/accounting/reports?report_type=balance_sheet',
              requiredPermissions: ['accounts.view'],
            ),
            AppNavigationItem(
              key: 'cash-flow',
              ...
              path: '/accounting/reports?report_type=cash_flow',
              requiredPermissions: ['accounts.view'],
            ),
            AppNavigationItem(
              key: 'financial-statement-pack',
              title: 'Financial Statement Pack',
              icon: Icons.folder_special_outlined,
              path: '/accounting/reports?report_type=financial_statement_pack',
              requiredPermissions: ['accounts.view'],
            ),
          ],
        ),
    ...
    const AppNavigationItem(
      ...
      children: [
        ...
        AppNavigationItem(
          ...
          requiredPermissions: ['project_timesheet.view'],
        ),
        AppNavigationItem(
          ...
          requiredPermissions: ['project_expense.view'],
        ),
        AppNavigationItem(
          ...
          requiredPermissions: ['project_resource.view'],
        ),
        AppNavigationItem(
          ...
          requiredPermissions: ['project_vendor.view'],
        ),
        AppNavigationItem(
          ...
          requiredPermissions: ['project_billing.view'],
        ),
      ],
    ),
    const AppNavigationItem(
