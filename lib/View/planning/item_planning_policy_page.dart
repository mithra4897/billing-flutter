...
class _ItemPlanningPolicyPageState extends State<ItemPlanningPolicyPage> {
  ...
  void initState() {
    super.initState();
    _controllerTag = '${ItemPlanningPolicyViewModel}_${identityHashCode(this)}';
    _viewModel = Get.put(
  ...
  @override
  void dispose() {
    if (Get.isRegistered<ItemPlanningPolicyViewModel>(tag: _controllerTag)) {
      Get.delete<ItemPlanningPolicyViewModel>(tag: _controllerTag);
    }
