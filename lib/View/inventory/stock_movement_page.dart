...
class _StockMovementPageState extends State<StockMovementPage> {
  ...
  void initState() {
    super.initState();
    _controllerTag = '${StockMovementViewModel}_${identityHashCode(this)}';
    _viewModel = Get.put(
  ...
  @override
  void dispose() {
    if (Get.isRegistered<StockMovementViewModel>(tag: _controllerTag)) {
      Get.delete<StockMovementViewModel>(tag: _controllerTag);
    }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<StockMovementViewModel>(
      tag: _controllerTag,
      builder: (_) {
