...
class _AmcContractPageState extends State<AmcContractPage> {
  ...
  void initState() {
    super.initState();
    _controllerTag = '${AmcContractViewModel}_${identityHashCode(this)}';
    _viewModel = Get.put(
  ...
  @override
  void dispose() {
    if (Get.isRegistered<AmcContractViewModel>(tag: _controllerTag)) {
      Get.delete<AmcContractViewModel>(tag: _controllerTag);
    }
