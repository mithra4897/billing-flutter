final class ActivityWatchSchema {
  ...
  static const Set<String> indexNames = <String>{
    'idx_device_sessions_user_started',
    'idx_activity_segments_session_started',
    'idx_activity_segments_state_started',
    'idx_application_segments_session_started',
    'idx_browser_segments_session_started',
    'idx_inventory_session_type_captured',
    'idx_system_events_session_event',
    'idx_system_events_type_event',
