...
Markdown supports headings, bullets, numbered items, bold and italic spans,
standard pipe-delimited tables, line breaks and blank-line spacing. Table
blocks are rendered with borders and a shaded header and paginate as one block.
Blocks are estimated against the available body height so long content flows to
additional template-backed pages without covering footer/signature areas.
